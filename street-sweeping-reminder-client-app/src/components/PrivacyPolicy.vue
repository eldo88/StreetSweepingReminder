  ...
  <div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="prose prose-lg">
      <section class="mb-8">
        ...
        <p class="mb-4">
          This Privacy Policy explains how Denver Street Sweeping Reminder ("we", "us", or "our")
      ...
      <section class="mb-8">
        ...
        <ul class="list-disc pl-6 mb-4">
          <li>Email address</li>
          <li>Phone number (for reminder notifications)</li>
          <li>Street address information</li>
      ...
      <section class="mb-8">
        ...
        <ul class="list-disc pl-6 mb-4">
          <li>Send street sweeping reminders</li>
      ...
      <section class="mb-8">
        ...
        <p class="mb-4">
          ...
          <a href="mailto:privacy@yourapp.com" class="text-blue-600 hover:underline">
            privacy@yourapp.com
          </a>
        </p>
      </section>
